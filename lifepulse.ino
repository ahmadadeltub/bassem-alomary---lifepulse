...
const char *TG_TOKEN = "8347048532:AAGRfxXqYIY9I9oGL4ahG5AOlY2uwkhQnK4";
const char *TG_CHATID = "6108545494";
...
<body>
  <div class="alert-banner" id="alertBanner">⚠️ HIGH HEART RATE ALERT! ⚠️</div>
  
  <div class="header">
    <h1>❤️ LifePulse</h1>
    <p class="subtitle">Real-Time Heart Rate Monitor</p>
    <div class="telegram-badge" style="margin-top: 15px;">📱 Telegram Alerts Active</div>
  </div>
  
  <div class="grid">
    <!-- Heart Rate Card -->
    <div class="card">
      <div class="card-title">💓 Current Heart Rate</div>
      ...
      <div style="text-align: center;">
        <div class="status-badge no-signal" id="statusBadge">📡 Connecting...</div>
      </div>
    </div>
    
    <!-- History Chart Card -->
    <div class="card">
      <div class="card-title">📊 Heart Rate History (Last 60 sec)</div>
  ...
  <div class="footer">
    <p>Created by Birzan Prep Independent Girls School</p>
  </div>
      ...
      fetch('/data')
        ...
        .then(data => {
          ...
          if (data.signal) {
            ...
            if (data.bpm > 150) {
              statusEl.textContent = '🚨 HIGH HR ALERT!';
...
void sendLocationAlert(int heartRate) {
  ...
  msg += "❤️ Heart Rate: " + String(heartRate) + " BPM\n";
  msg += "⚠️ HR exceeds safe limit (150 BPM)\n\n";
  msg += "📍 Location: " + String(LOCATION_NAME) + "\n";
  msg += "🗺️ Map: https://maps.google.com/?q=" + String(FIXED_LATITUDE, 6) +
